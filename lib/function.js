...
async function WriteSession() {
  try {
    ...
    if (process.env.SESSION !== undefined) {
      ...
      // If `body` is already an object, don't parse it
      const raw = body.result; // assume result is already an object

      // If raw is a stringified JSON, parse it — otherwise skip
